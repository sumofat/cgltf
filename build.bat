...
cl %CommonCompilerFlagsNoLink%  ../cgltf.h -Fdcgltf.pdb -Fmcgltf.map /c

REM lib win32.obj Kernel32.lib user32.lib gdi32.lib winmm.lib Ws2_32.lib Ole32.lib Xinput9_1_0.lib DXGI.lib D3D12.lib D3DCompiler.lib ../../fmj/build/fmj.lib
lib cgltf.obj
popd
